...
A single workflow (`.github/workflows/ci.yml`) builds and tests the four Node projects in parallel via a matrix. The two docs-only projects have no pipeline.
